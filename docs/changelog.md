...
- **Test suite** — 565 automated tests (pytest), flake8-clean.
...
- Numerous UI stability fixes: rounded-corner toplevels, theme-flip tag reapplication, wizard RAM slider/step3 layout, Modrinth status feedback silently dropped.

### Validation
- 565 tests passing on Windows (pytest, flake8 clean).
