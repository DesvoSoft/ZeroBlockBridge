...
def _generate_eula(server_dir: str, accepted: bool):
    ...
    try:
        ...
        raise PermissionError(f"Cannot write {eula_path}: permission denied.") from e
...
def _generate_properties(server_dir: str, port: int, config: dict = None):
    ...
    if not os.path.exists(props_path):
        try:
            ...
            raise PermissionError(f"Cannot write {props_path}: permission denied.") from e
...
def _create_directories(server_dir: str):
    ...
    for folder in _SCAFFOLD_DIRS:
        ...
        try:
            ...
            raise PermissionError(f"Cannot create {folder_path}: permission denied.") from e
