class AppConfig:
    ...
    COLOR_ACCENT_BROWN = ("#92400e", "#92400e")        # amber-800
    COLOR_ACCENT_BROWN_HOVER = ("#78350f", "#78350f")  # amber-900
    COLOR_ACCENT_GREEN = ("#4d7c0f", "#4d7c0f")        # lime-800
    COLOR_ACCENT_GREEN_HOVER = ("#3f6212", "#3f6212")  # lime-900
    COLOR_ACCENT_AMBER = ("#d97706", "#d97706")        # amber-600
    COLOR_ACCENT_AMBER_HOVER = ("#b45309", "#b45309")  # amber-700

    # Colors - Status
    COLOR_STATUS_ONLINE = ("#84cc16", "#84cc16")    # lime-400
    COLOR_STATUS_OFFLINE = ("#94a3b8", "#64748b")   # slate-400 / slate-500
    COLOR_STATUS_STARTING = ("#f59e0b", "#f59e0b")  # amber-400
    COLOR_STATUS_ERROR = ("#f87171", "#f87171")     # red-400

    COLOR_TEXT_PRIMARY = ("#0f172a", "#f1f5f9")  # slate-950 / slate-100
    COLOR_TEXT_GRAY = ("#64748b", "#94a3b8")     # slate-500 / slate-400
    COLOR_TEXT_NOTE = ("#64748b", "#64748b")     # slate-500
    COLOR_TEXT_MUTED = ("#64748b", "#475569")    # slate-500 / slate-600
    ...
    COLOR_BTN_PRIMARY_HOVER = ("#4d7c0f", "#4d7c0f")    # lime-700
    COLOR_BTN_SUCCESS = ("#16a34a", "#16a34a")           # green-600
    COLOR_BTN_SUCCESS_HOVER = ("#15803d", "#15803d")     # green-700
    COLOR_BTN_DANGER = ("#dc2626", "#dc2626")            # red-600
    COLOR_BTN_DANGER_HOVER = ("#b91c1c", "#b91c1c")     # red-700
